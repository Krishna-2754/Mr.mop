...
<body>
	...
	<div class="container">
		...
		<div class="login-content">
			<form:form method="post" action="/submitstudata" modelAttribute="stu">
				...
				<h2 class="title">Welcome</h2>
           		...
           		<div class="i">
	           		...
	           		<div class="div">
	           		   		<h5>First Name</h5>
	           		   		<form:input path="fname" class="input" type="text"/>
	           		</div>
           		</div>
           		<div class="input-div one">
           		<div class="i">
           			...
           			<div class="div">
           		   		<h5>Last Name</h5>
           		   		<form:input path="lname" class="input" type="text"/>
           		   </div>
           		</div>
           		<div class="input-div one">
           		<div class="i">
            	...
            	<div class="input-div pass">
            		...
            		<div class="div">
           		    	...
           		    	<form:input path="password2" class="input" type="password"/>
            	   </div>
            	</div>
